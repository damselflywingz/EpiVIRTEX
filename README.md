...
* See the manuscript and details in the [Updated20240121__2022_15_15_script_smallRNA_calu_3_proc_align_quant_S1_and_S2.R](https://github.com/damselflywingz/EpiVIRTEX/tree/main/Scripts/Updated20240121__2022_15_15_script_smallRNA_calu_3_proc_align_quant_S1_and_S2.R) script.
* Processing of raw sequencing reads into counts per million is described in the script.
* To avoid processing of raw reads, we also have provided the count data from bedtools genomecov for each of the [Wyler et al. 2021](https://www.cell.com/iscience/fulltext/S2589-0042(21)00119-X?elqTrackId=a5fb8ddc3ea24283adca366859fed54e) small RNA-seq libraries, and are found in the EpiVIRTEX/Data/ folder. 
 
## Recombination breakpoint and hotspot analysis

* Refer to [EpiVIRTEX/Scripts/20240308_random_breakpoint_script.R](https://github.com/damselflywingz/EpiVIRTEX/tree/main/Scripts/20240308_random_breakpoint_script.R) for more information.

## Host-homology searches and visualization

* Refer to [EpiVIRTEX/Scripts/20240308_R_script_blast_results_heatmap_PCA.R](https://github.com/damselflywingz/EpiVIRTEX/tree/main/Scripts/20240308_R_script_blast_results_heatmap_PCA.R) for more information.

## Synonymous-site conservation analysis and combined genomic visualization

* Refer to [EpiVIRTEX/Scripts/20240905_SynPlot2_Align_tree.R](https://github.com/damselflywingz/EpiVIRTEX/tree/main/Scripts/20240905_SynPlot2_Align_tree.R) for more information.

## Venn diagrams for potential TFO targets

* Refer to [EpiVIRTEX/Scripts/20240721_Script_DE_metaAnalysis_venn.R](https://github.com/damselflywingz/EpiVIRTEX/tree/main/Scripts/20240721_Script_DE_metaAnalysis_venn.R) for more information.
