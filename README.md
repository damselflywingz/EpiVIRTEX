...
* Using Triplexator to predict triplex-forming oligonucleotides in viral genome compared to known enhancer sequences from human lungs [Enahncer Atlas](http://www.enhanceratlas.org/indexv1.php).
* See manuscript and refer to [EpiVIRTEX/Scripts/20250909_Epi-VIRTEX_miRNA_prediction.txt](https://github.com/damselflywingz/EpiVIRTEX/tree/main/Scripts/20250909_Epi-VIRTEX_miRNA_prediction.txt) for more information.
